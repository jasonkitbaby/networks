...
if __name__ == '__main__':
    ...
    f = open('../../../logs/part2-module2.1.log','w')	
    ...
    plt.grid(True)
    plt.savefig("../../../target/出度用户-产品网金额和平均度.png",dpi=1024,figsize=1024)
    ...
    plt.ylabel('avg degree')
    plt.title('out degree user')
    plt.savefig("../../../target/出度用户-产品网金额和平均度-双log图.png",dpi=1024,figsize=1024)
...
if __name__ == '__main__':
    ...
    f = open('../../../logs/part2-module3.4.log','w')	
    ...
    plt.grid(True)
    plt.savefig("../../../target/入出度用户-产品网等级和平均度.png",dpi=1024,figsize=1024)
    ...
    plt.ylabel('avg degree')
    plt.title('in out degree user')
    plt.savefig("../../../target/入出度用户-产品网等级和平均度-双log图.png",dpi=1024,figsize=1024)